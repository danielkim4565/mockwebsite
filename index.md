  ...
  <body>
    ...
    <p>
      <em
        >Student at the
        <strong
          ><a href="https://uwaterloo.ca/">University of Waterloo</a> </strong
        >.</em
      >
    </p>
    <p>
      I am studying data science at the University of Waterloo and I like video
      games.
    </p>
    <hr />
    <h2>Education</h2>
    <ul>
      <li>Highschool diploma (John Polanyi collegiate instituite)</li>
    </ul>
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td>2019-2020</td>
          <td>Mcdonald's Crew Member</td>
        </tr>
        <tr>
          <td>2020-2021</td>
          <td>FireHouse Subs Crew Member</td>
        </tr>
      </tbody>
    </table>
  </body>
